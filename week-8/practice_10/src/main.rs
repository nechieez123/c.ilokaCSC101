fn main() {
    ...
    println!("index o to index 3 sliced = {:?}", slice2);

    // omit the end index
    let slice3 = &numbers[2..5];
    // This means the slice starts from index2 and goes up to index 5 (exclusive)
